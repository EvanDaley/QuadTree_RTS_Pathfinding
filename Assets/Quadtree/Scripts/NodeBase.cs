...
namespace Quadtree
{
        ...
        where TNode : NodeBase<TItem, TNode>, new()
    {
        ...
        {
          if (displayNumberOfItems && _items.Count > 0)
          {
            GUIStyle style = new GUIStyle();
            style.fontSize = 25; // Increase the font size to 30
            style.fontStyle = FontStyle.Bold;
            style.normal.textColor = Color.red; // Set the font color to red

            Handles.Label(Bounds.center, _items.Count.ToString(), style);
          }
